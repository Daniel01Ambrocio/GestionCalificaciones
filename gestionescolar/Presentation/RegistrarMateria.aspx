<%@ Page Title="" Language="C#" MasterPageFile="~/Presentation/menu.Master" AutoEventWireup="true" CodeBehind="RegistrarMateria.aspx.cs" Inherits="gestionescolar.Presentation.RegistrarMateria" %>
                ...
                <div class="card">
                    ...
                    <div class="card-body p-0">
                        <asp:GridView runat="server" ID="gvMaterias" CssClass="table table-striped table-bordered mb-0"
                            AutoGenerateColumns="False" GridLines="None" DataKeyNames="IDMateria"
                            OnRowDeleting="gvMaterias_RowDeleting">
                            <Columns>
                                <asp:BoundField DataField="Nombre" HeaderText="Materia" />
                                <asp:BoundField DataField="GradoEscolar" HeaderText="Grado" />
                                ...
                                <asp:TemplateField HeaderText="Acciones">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="btnEliminar" runat="server" CommandName="Delete"
                                            ...
                                            OnClientClick="return confirm('¿Está seguro que desea eliminar esta materia?');">
                                        </asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <asp:TextBox runat="server" CssClass="form-control" ID="txtGradoEscolar" />
                        </div>
