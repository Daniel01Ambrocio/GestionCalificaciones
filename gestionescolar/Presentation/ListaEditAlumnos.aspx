<%@ Page Title="" Language="C#" MasterPageFile="~/Presentation/menu.Master" AutoEventWireup="true" CodeBehind="ListaEditAlumnos.aspx.cs" Inherits="gestionescolar.Presentation.ListaEditAlumnos" %>
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body p-0">
                            <asp:GridView runat="server" ID="gvAlumnos" CssClass="table table-striped table-bordered mb-0"
