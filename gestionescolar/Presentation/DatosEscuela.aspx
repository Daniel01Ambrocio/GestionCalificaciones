                        ...
                        <EditItemTemplate>
                            <table class="table table-borderless mb-0">
                                <tr>
                                    <th>Nombre Escuela</th>
                                    <td>
                                        <asp:TextBox ID="txtNombreEscuela" runat="server" Text='<%# Bind("NombreEscuela") %>' CssClass="form-control" /></td>
                                </tr>
                                <tr>
                                    <th>Clave Institución</th>
                                    <td>
                                        <asp:TextBox ID="txtClaveInstitucion" runat="server" Text='<%# Bind("ClaveInstitucion") %>' CssClass="form-control" /></td>
                                </tr>
                                <tr>
                                    <th>Dirección</th>
                                    <td>
                                        <asp:TextBox ID="txtDireccion" runat="server" Text='<%# Bind("Direccion") %>' CssClass="form-control" /></td>
                                </tr>
                                <tr>
                                    <th>Teléfono</th>
                                    <td>
                                        <asp:TextBox ID="txtTelefono" runat="server" Text='<%# Bind("Telefono") %>' CssClass="form-control" /></td>
                                </tr>
                                <tr>
                                    <th>Logotipo</th>
                                    <td>
                                ...
                                <tr>
                                    <th>Ciclo Escolar</th>
                                    <td>
                                        <asp:TextBox ID="txtCicloEscolar" runat="server" Text='<%# Bind("CicloEscolar") %>' CssClass="form-control" /></td>
                                </tr>
                                <tr>
                                    <td colspan="2">
